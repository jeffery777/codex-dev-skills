...
CLI fallback: use `project-delivery` and `project-orchestrator`, generate task briefs, run review primitives sequentially, and run formal gates only at commit readiness, PR readiness, merge readiness, or explicit repo-policy gates.

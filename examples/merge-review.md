...
Read the current merge-review or merge-review-deep evidence, summarize blockers and residual risk, and report READY, BLOCKED, or NEEDS HUMAN DECISION. Do not merge or push.
```

The gate is a thin evidence-and-decision layer. It is not another merge review primitive and does not automatically authorize merge.

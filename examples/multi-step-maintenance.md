...
Stop before commit, push, merge, release, issue updates, PR comments, or any external write unless I explicitly authorize that step.
```
...
8. Stop at the human gate before commit, push, merge, release, issue updates, PR comments, or any other external write.

If the maintainer later authorizes external writes, Codex should restate the changed files, validation, review outcome, and residual risk before committing, pushing, opening a PR, posting comments, or merging.

...
- Heterogeneous routes must also record task factors, selected capability class
  and role, resolved or unresolved runtime mapping, fallback, assigned scope and

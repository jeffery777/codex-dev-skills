...
Use `project-delivery` with generated task briefs and separate implementation/review passes.

## Workflow

1. Main agent bootstraps from durable repo artifacts and git state.
2. Main agent defines scope, ownership, phase plan, verification, and human gates.

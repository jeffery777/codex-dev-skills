...
- `../../templates/orchestration/implementation-plan.template.md` or `${CODEX_TEMPLATES_DIR:-$HOME/.codex/templates}/orchestration/implementation-plan.template.md`
- `../../templates/orchestration/project-spec.template.md` or `${CODEX_TEMPLATES_DIR:-$HOME/.codex/templates}/orchestration/project-spec.template.md`

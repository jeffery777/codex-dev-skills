...
| Failure and response handling | `auth-or-permission-failure-stops`; `malformed-or-absent-response-stops`; `missing-or-invalid-identity-stops` | `DesktopWrapperSecurityFixtureTests.test_case_mappings_are_complete_and_reference_existing_test_symbols` |

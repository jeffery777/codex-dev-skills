...
mutation. The Memory M1 target release remains **TBD / human decision**.
...
| M1-FU-04 / gated | Observe efficacy separately from safety/conformance and decide activation, promotion, and release target. M1 does not establish that recall improves outcomes. | The candidate remains default-disabled and cannot claim efficacy or select its own release. | Product/maintainer human gate / target TBD | Pre-register bounded efficacy criteria and independent observations without changing M0 authority. | Proposal to activate, promote, or assign a release target. |
